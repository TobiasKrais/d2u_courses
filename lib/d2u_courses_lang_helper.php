...
class d2u_courses_lang_helper extends \D2U_Helper\ALangHelper {
	...
	protected $replacements_english = [
		...
		'd2u_courses_cart_heading' => 'Registration form',
		...
		'd2u_courses_price_salery_level' => 'Monthly family income',
		'd2u_courses_price_salery_level_details' => 'The price is based on the monthly family income. We trust that the classification will be made honestly. We reserve the right to check on our part.',
	...
	protected $replacements_german = [
		...
		'd2u_courses_cart_contact_address' => 'Kontaktadresse',
		...
		'd2u_courses_cart_heading' => 'Anmeldeformular',
		...
		'd2u_courses_details_course' => 'Informationen zur Veranstaltung',
		...
		'd2u_courses_price_salery_level' => 'Monatliches Familieneinkommen',
		'd2u_courses_price_salery_level_details' => 'Der Preis richtet sich nach dem monatlichen Familieneinkommen. Wir vertrauen darauf, dass Ihre Einstufung wahrheitsgemäß und ehrlich erfolgt. Eine Überprüfung unsererseits bleibt uns vorbehalten.',
