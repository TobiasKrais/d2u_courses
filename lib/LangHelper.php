...
class LangHelper extends \TobiasKrais\D2UHelper\ALangHelper
{
    ...
    public $replacements_english = [
        ...
        'd2u_courses_cart_error_honeypot' => 'You filled out a field that is invisible and should not be filled out. Please check your entries.',
        'd2u_courses_cart_go_to' => 'Go to cart',
        'd2u_courses_cart_iban_not_sepa' => 'To avoid extra costs, check whether your bank allows free sepa direct debits. Possible additional costs will be charged to you.',
        'd2u_courses_cart_iban_wrong' => 'IBAN is wrong. Please check.',
        'd2u_courses_cart_nationality' => 'Nationality',
        'd2u_courses_cart_nationality_others' => 'Other nationality',
        'd2u_courses_cart_nationality_CH' => 'Switzerland',
        'd2u_courses_cart_nationality_DE' => 'Germany',
        'd2u_courses_cart_nationality_FL' => 'Liechtenstein',
        'd2u_courses_cart_nationality_FR' => 'France',
        'd2u_courses_cart_nationality_IT' => 'Italy',
        'd2u_courses_cart_nativeLanguage' => 'Native language',
        'd2u_courses_cart_nativeLanguage_others' => 'Other language',
        'd2u_courses_cart_nativeLanguage_DE' => 'German',
        'd2u_courses_cart_nativeLanguage_FR' => 'French',
        'd2u_courses_cart_nativeLanguage_IT' => 'Italian',
        'd2u_courses_cart_participant' => 'Participant',
        'd2u_courses_cart_pension_insurance_id' => 'Pension insurance ID',
        'd2u_courses_cart_save' => 'Save cart and continue shopping',
        'd2u_courses_cart_thanks' => 'Thank you for your registration',
        'd2u_courses_cart_thanks_details' => 'We review your request manually. Please note that your registration is only legally binding after our confirmation. You will receive a confirmation email after our manual check. This takes up to 3-4 working days. If you do not receive our confirmation mail in exceptional cases, please call us. Thank you for your understanding!',
        'd2u_courses_city' => 'City',
        'd2u_courses_company' => 'Company',
        'd2u_courses_country' => 'Country',
        'd2u_courses_country_others' => 'Other Country',
        'd2u_courses_country_CH' => 'Switzerland',
        'd2u_courses_country_DE' => 'Germany',
        'd2u_courses_country_FL' => 'Liechtenstein',
        'd2u_courses_country_FR' => 'France',
        'd2u_courses_country_IT' => 'Italy',
        ...
        'd2u_courses_kids_go_home_alone' => 'May go home alone.',
        ...
        'd2u_courses_none_found' => 'We are sorry. Currently there are no offers available. Please check back later.',
        'd2u_courses_none_found_heading' => 'No offers found',
        ...
        'd2u_courses_photo_permission' => 'May be photographed during the event.',
    ...
    protected array $replacements_german = [
        ...
        'd2u_courses_cart_error_honeypot' => 'Sie haben ein Feld ausgefüllt, welches nicht ausgefüllt werden sollte weil es unsichtbar ist. Bitte überprüfen Sie Ihre Eingaben.',
        'd2u_courses_cart_go_to' => 'Zum Warenkorb',
        'd2u_courses_cart_iban_not_sepa' => 'Um unerwartete Kosten zu vermeiden prüfen Sie bitte, ob Ihre Bank kostenlose SEPA Lastschriften ermöglicht. Eventuelle zusätzliche Kosten werden Ihnen berechnet.',
        'd2u_courses_cart_iban_wrong' => 'IBAN ist falsch. Bitte prüfen Sie die Eingabe.',
        'd2u_courses_cart_nationality' => 'Nationalität',
        'd2u_courses_cart_nationality_others' => 'Andere Nationalität',
        'd2u_courses_cart_nationality_CH' => 'Schweiz',
        'd2u_courses_cart_nationality_DE' => 'Deutsch',
        'd2u_courses_cart_nationality_FL' => 'Liechtenstein',
        'd2u_courses_cart_nationality_FR' => 'Frankreich',
        'd2u_courses_cart_nationality_IT' => 'Italien',
        'd2u_courses_cart_nativeLanguage' => 'Muttersprache',
        'd2u_courses_cart_nativeLanguage_others' => 'Andere Sprache',
        'd2u_courses_cart_nativeLanguage_DE' => 'Deutsch',
        'd2u_courses_cart_nativeLanguage_FR' => 'Französisch',
        'd2u_courses_cart_nativeLanguage_IT' => 'Italienisch',
        'd2u_courses_cart_participant' => 'Teilnehmer*in',
        'd2u_courses_cart_pension_insurance_id' => 'Rentenversicherungsnummer',
        ...
        'd2u_courses_country_others' => 'Anderes Land',
        'd2u_courses_country_CH' => 'Schweiz',
        'd2u_courses_country_DE' => 'Deutschland',
        'd2u_courses_country_FL' => 'Liechtenstein',
        'd2u_courses_country_FR' => 'Frankreich',
        'd2u_courses_country_IT' => 'Italien',
        ...
        'd2u_courses_kids_go_home_alone' => 'Darf alleine nach Hause gehen',
        ...
        'd2u_courses_none_found' => 'Wir bedauern, dass aktuell keine Angebote verfügbar sind. Bitte schauen Sie später wieder vorbei.',
        'd2u_courses_none_found_heading' => 'Keine Angebote gefunden',
        ...
        'd2u_courses_photo_permission' => 'Darf während der Veranstaltung fotografiert werden.',
        ...
        'd2u_courses_search' => 'Suche',
        'd2u_courses_search_no_hits' => 'Keine Treffer',
        'd2u_courses_search_no_hits_text' => 'Ihre Suche in unseren Kursen und Angeboten erzielte keine Treffer.<br>Versuchen Sie, nur nach einem Wortteil zu suchen, z.B. statt "Malworkshop" einfach nur "Mal" oder "malen".',
    ...
    public function install(): void
    {
        foreach ($this->replacements_english as $key => $value) {
            foreach (rex_clang::getAllIds() as $clang_id) {
                ...
                $overwrite = 'true' === rex_config::get('d2u_courses', 'lang_wildcard_overwrite', false) ? true : false;
