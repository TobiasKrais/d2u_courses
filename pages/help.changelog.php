...
<ul>
	...
	<li>Security: In den Modulen <code>modules/26/1</code>, <code>26/3</code>, <code>26/4</code>, <code>26/6</code> werden Box-Helper (<code>printBoxModule26_*</code>), <code>href</code>-URLs (Kurs-, News- und Kategorie-Links), Bild-Dateinamen und das eingehende <code>course_search</code>-POST-Feld jetzt mit <code>rex_escape()</code> bzw. <code>rawurlencode()</code> ausgegeben. Google-Maps-API-Key wird vor der Einbettung URL-kodiert; Map-IDs und Zoom-Level strikt als <code>(int)</code> bzw. <code>(float)</code> gecastet, Standortname und Adresse über <code>json_encode()</code> in JS-Strings übergeben.</li></ul>
<p>3.6.0:</p>
<ul>
