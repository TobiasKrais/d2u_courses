		...
		<div class="panel panel-edit">
			...
			<div class="panel-body">
				...
				<?php
                    ...
                    d2u_addon_backend_helper::form_select('d2u_courses_categories_parent_category', 'form[parent_category_id]', $options_parents, false === $category->parent_category ? [-1] : [$category->parent_category->category_id], 1, false, $readonly);
