...
<div class="row">
	...
	<div class="col-xs-8">
		<?php
            ...
            echo '<option value="3" '. (3 === (int) 'REX_VALUE[5]' ? 'selected="selected" ' : '') .'>3</option>'; /** @phpstan-ignore-line */
            echo '<option value="4" '. (4 === (int) 'REX_VALUE[5]' ? 'selected="selected" ' : '') .'>4</option>'; /** @phpstan-ignore-line */
            echo '</select>';
        ?>
	</div>
</div>
